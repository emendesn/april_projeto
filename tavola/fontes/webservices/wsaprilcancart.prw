...
com o objetivo de realizar cancelamentos de Cartão na tabela Ponte Customizada SZ0.
...
WSSERVICE WsAprilCanCart DESCRIPTION "Serviço destinado ao cancelamento na tabela MIDDLEWARE como ponte para emissão Faturas Tavola x Protheus"
 
	Wsdata WSSOLCANCCAR As EstrSolCCART
	Wsdata WSRETCANCCAR	As EstrRetCCART
	
	//  Métodos //
	WsMethod CancCart Description "Cancelamento de Cartão na tabela no MIDDLEWARE para emissão Faturas: Távola x Protheus"
...
Begin Sequence
	...
	//Reseta ambientes --> verificar utilização pois algumas builds travam processamento.
	//RpcClearEnv() 
