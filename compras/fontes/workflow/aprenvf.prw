...
User Function AprEnvF2()
	local lxEnvmail    := .f.
	local _cRemet	   := ""
	Local _cAssunto := "Novo Fornecedor Cadastrado"                                    
	...
	_cQuery := " SELECT * FROM "+RetSQLName("SA2")+" A2 "
	_cQuery += " WHERE A2_MSBLQL ='1' AND A2.D_E_L_E_T_<>'*' "
	...
	_cHTML += "   <td height='97' colspan='3' bgcolor='#555555'><div align='center' class='style13'>Solicita&ccedil;&atilde;o de desbloqueio de Fornecedores  - April Turismos </div>"
	_cHTML += "   <div align='center'></div></td>"
	_cHTML += "  </tr>"
	_cHTML += " <tr>"
	_cHTML += "   <td width='160' height='23' bgcolor='#808080' class='style14'><p align='center'><strong>C&Oacute;DIGO FORNECEDOR</strong></p>    </td>"
	...
	While TRB->(!Eof())
			nX++
		_cHTML += "<tr>"
		_cHTML += "  <td height='45'>"+Alltrim(TRB->A2_COD)+"</td>"
		_cHTML += "  <td height='45'>"+Alltrim(TRB->A2_TIPO)+"</td>"
		_cHTML += "  <td height='45'>"+Alltrim(TRB->A2_NOME)+"</td>"
